 ...
 * @returns 
 */
    drawText(canvas, text, x, y, color = {r: 255, g: 255, b: 255, a: 255}) {
 ...
 * @returns 
 */
    drawTextWithTint(canvas, text, x, y, r, g, b, a = 255) {
        return this.drawText(canvas, text, x, y, { r, g, b, a });
    }
  ...
  * @returns 
  */
    drawMultilineText(canvas, text, x, y, maxWidth, align = 'left', color= {r: 255, g: 255, b: 255, a: 255}) {
        ...
        lines.forEach(line => {
            ...
            this.drawText(canvas, line, lineX, currentY, color);
